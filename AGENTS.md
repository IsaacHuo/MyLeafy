...
- User-created schedules use one editor and one user-facing concept: dates inside the current academic year project directly into the timetable, while dates outside it remain countdowns. School-provided exams remain a separate data source.
