...
Timetable direction:
- The root navigation order is `课表 / 社区 / 日迹 / 校园 / 我的`. The 日迹 tab keeps local memos as its root and opens a separate schedule hub for the personal natural-year week view and schedule reports; school exams, courses, and calendar data never enter the memo feed or personal schedule view.
