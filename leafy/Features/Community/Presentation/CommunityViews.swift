...
struct CommunityDraftAttachment: Identifiable, Hashable {
    let upload: CommunityAttachmentUpload

    var id: UUID { upload.id }
}

enum CommunityDraftSaveState: Equatable {
    case idle
    case saving
    case saved(Date)
    case failed(String)
...
struct CommunityDraftAutosaveSignature: Hashable {
...
struct CommunityAttachmentPreview: Identifiable {
    let id = UUID()
    let url: URL
}

struct CommunityAttachmentShareItem: Identifiable {
    let id = UUID()
    let url: URL
}

enum CommunityComposerAttachmentError: LocalizedError {
...
enum CommunityComposerAttachmentTypes {
...
enum CommunityModerationTarget: Identifiable, Equatable {
...
struct CommunityPollFeedCard: View {
...
struct CommunityFeedTopPreferenceKey: PreferenceKey {
...
struct CommunityPollDraftFields: View {
...
struct CommunityPublishTaskStrip: View {
...
struct CommunityPostAttachmentsSection: View {
...
struct CommunityAttachmentPreviewSheet: View {
    @Environment(\.dismiss) private var dismiss
...
struct CommunityQuickLookPreview: UIViewControllerRepresentable {
    let url: URL
...
struct CommunityPublishTaskRow: View {
...
enum CommunityComposerMode: String, CaseIterable, Identifiable, Hashable {
    case post
    case poll
