...
- 课表周视图可通过双指放大切换为真实昨天/今天/明天三列；三日模式始终索引七天内容，不受“隐藏周末”影响，捏合后返回周视图。两种模式共用预计算网格、考试和个人日程投影。
- 时间视图不展示已废弃的 2025–2026 春季入口，但底层历史学期配置仍保留；非教学期优先选择最近即将开始的学期，第一学期月份按 9 月至次年 1 月跨年展示。
