/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=staging` (hash: 29641ceca1dc9e0644da5a4494c478c3)
// Runtime types generated with workerd@1.20260708.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	FILES: R2Bucket;
	DB: D1Database;
	ENVIRONMENT: "staging";
	API_ORIGIN: "https://myleafy-api-staging.2210286979.workers.dev";
	SITE_ORIGIN: "http://localhost:5173";
	SIGNALS: DurableObjectNamespace<import("./src/index").ChangeSignals>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChangeSignals";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "API_ORIGIN" | "SITE_ORIGIN">> {}
}
