...
it("attachment validator recognizes bounded PDF shape", () => {
...
it("attachment validator accepts UTF-8 markdown and rejects binary NUL", () => {
...
it("attachment validator enforces the 10 MB object limit", () => {
...
it("attachment validator rejects forged MIME and extension combinations", () => {
...
it("attachment validator sanitizes display names", () => {
...
it("attachment validator normalizes UUID casing for storage path matching", () => {
  assert(
...
it("attachment validator reads a consistent OOXML central directory", () => {
