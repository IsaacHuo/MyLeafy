...
begin
  ...
  if target_edu_id = 'review-demo'
     or target_edu_id like 'review-demo-%' then
...
comment on function public.edge_delete_community_account(uuid) is
  'Deletes the community profile linked to an authenticated user. Service-role only; the Edge Function validates the caller JWT.';
